...
print("Sum of the unique elements are ", unique_elements)
...
my_list_1 = [6,7,8,9]
my_list_2 = [8,5,8,9]
joined_list = my_list_1 + my_list_2
unique_elements = {x for x in joined_list if joined_list.count(x) == 1}
print("set of the unique values is ", unique_elements)
